...
def build_feature_matrix(df, predict_date, train_cutoff=None):
    ...
    # V3 ADDITION: Include opp_fpts_allowed_10g if available
    ...
    X = predict_games[feature_cols + opp_features + nst_features].reset_index(drop=True).copy()
