#!/usr/bin/env python3
"""Worker for parameter exploration run 4"""
...
config.PRIMARY_STACK_BOOST = 0.1
config.GOALIE_CORRELATION_BOOST = 0.05
...
summary = {
    ...
    'params': {
        'dk_avg_blend': 0.8,
        'primary_stack_boost': 0.1,
        'goalie_corr_boost': 0.05,
    },
    'n_slates': len(rdf),
...
out_path = '/Users/brendanhorlbeck/Desktop/Code/projection/backtest_results/run_4.json'
with open(out_path, 'w') as f:
    json.dump(summary, f, indent=2)

print(f"Run 4 done: {len(rdf)} slates, M3σ edge={rdf['m3s_edge'].mean():+.1f}, "
