...
summary = dict(
    run_id=4, label='DIVERSE gen + 90/10 blend',
...
with open('/Users/brendanhorlbeck/Desktop/Code/projection/backtest_results/run_4.json', 'w') as f:
    json.dump(summary, f, indent=2)
print(f"Run 4: {len(rdf)} slates, edge={rdf['m3s_edge'].mean():+.1f}, {elapsed:.0f}s")
