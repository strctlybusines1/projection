#!/usr/bin/env python3
"""Worker for parameter exploration run 1"""
...
import config
config.DK_AVG_BLEND_WEIGHT = 0.7
...
out_path = '/Users/brendanhorlbeck/Desktop/Code/projection/backtest_results/run_1.json'
with open(out_path, 'w') as f:
    json.dump(summary, f, indent=2)

print(f"Run 1 done: {len(rdf)} slates, M3σ edge={rdf['m3s_edge'].mean():+.1f}, "
