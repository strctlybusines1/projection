#!/usr/bin/env python3
"""Worker for parameter exploration run 2"""
...
summary = {
    ...
    'params': {
        'dk_avg_blend': 0.9,
        'primary_stack_boost': 0.2,
        'goalie_corr_boost': 0.1,
    },
    'n_slates': len(rdf),
...
out_path = '/Users/brendanhorlbeck/Desktop/Code/projection/backtest_results/run_2.json'
with open(out_path, 'w') as f:
    json.dump(summary, f, indent=2)

print(f"Run 2 done: {len(rdf)} slates, M3σ edge={rdf['m3s_edge'].mean():+.1f}, "
