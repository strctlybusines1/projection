#!/usr/bin/env python3
"""Worker for parameter exploration run 0"""
...
out_path = '/Users/brendanhorlbeck/Desktop/Code/projection/backtest_results/run_0.json'
with open(out_path, 'w') as f:
    json.dump(summary, f, indent=2)

print(f"Run 0 done: {len(rdf)} slates, M3σ edge={rdf['m3s_edge'].mean():+.1f}, "
