...
summary = dict(
    run_id=0, label='Triple-mix + 80/20 blend (BASELINE)',
...
with open('/Users/brendanhorlbeck/Desktop/Code/projection/backtest_results/run_0.json', 'w') as f:
    json.dump(summary, f, indent=2)
print(f"Run 0: {len(rdf)} slates, edge={rdf['m3s_edge'].mean():+.1f}, {elapsed:.0f}s")
